...
this.turingFile="./turing.csv";this.turingImage="./png/acm-turing-award.png";this.acmfellowFile="./acm-fellows.csv";this.acmfellowImage="./png/acm.png";this.homepageImage="./house-logo.png";this.allowRankingChange=!1;this.areaMap=[{area:"social",title:"Social"},{area:"tcss",title:"Social"},{area:"tsc",title:"Social"},{area:"socnet",title:"Social"},{area:"ai",title:"AI"},{area:"aaai",title:"AI"},{area:"ijcai",title:"AI"},{area:"vision",title:"Vision"},{area:"cvpr",title:"Vision"},{area:"eccv",title:"Vision"},{area:"iccv",title:"Vision"},{area:"mlmining",title:"ML"},{area:"icml",title:"ML"},{area:"kdd",title:"ML"},
...
CSRankings.prototype.activateSocial=function(a){return this.activateFields(void 0===a?!0:a,this.socialFields)};
CSRankings.prototype.deactivateSocial=function(){return this.activateSocial(!1)};
...
l.next();!p.done;p=l.next()){p=p.value;var q="input[name="+p+"]";p in CSRankings.nextTier?$(q).prop("checked",!1):$(q).prop("checked",k)}}a.rank(g)}}(b));var f={social_areas_on:function(){a.activateSocial()},social_areas_off:function(){a.deactivateSocial()}};b={};for(var h in f)b.$jscomp$loop$prop$item$37=h,document.getElementById(b.$jscomp$loop$prop$item$37).addEventListener("click",function(e){return function(){f[e.$jscomp$loop$prop$item$37]()}}(b)),b={$jscomp$loop$prop$item$37:b.$jscomp$loop$prop$item$37}};CSRankings.minToRank=30;CSRankings.areas=[];CSRankings.topLevelAreas={};CSRankings.topTierAreas={};CSRankings.regions="us europe ca northamerica southamerica australasia asia africa world".split(" ");
CSRankings.nameMatcher=/(.*)\s+\[(.*)\]/;CSRankings.parentIndex={};
CSRankings.parentMap={tcss: 'social',tsc: 'social',socnet: 'social'};
