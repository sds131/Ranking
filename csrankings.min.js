...
c;this.fields[b]=d;this.areaDict[d]=c;this.areaPosition[d]=b}b=$jscomp.makeIterator(this.socialAreas);for(d=b.next();!d.done;d=b.next())this.socialFields.push(this.areaPosition[d.value]);b=0;for(var f in CSRankings.parentMap)d=CSRankings.parentMap[f],d in CSRankings.childMap?CSRankings.childMap[d].push(f):(CSRankings.childMap[d]=[f],CSRankings.parentIndex[d]=b,b+=1);this.displayProgress(1);(function(){return __awaiter(a,void 0,void 0,function e(){var h=this;return $jscomp.generator.createGenerator(e,
function(k){switch(k.nextAddress){case 1:return k.yield(h.loadTuring(h.turing),2);case 2:return k.yield(h.loadACMFellow(h.acmfellow),3);case 3:return h.displayProgress(2),k.yield(h.loadAuthorInfo(),4);case 4:return h.displayProgress(3),k.yield(h.loadAuthors(),5);case 5:return h.setAllOn(),h.navigoRouter.on({"/index":h.navigation,"/fromyear/:fromyear/toyear/:toyear/index":h.navigation}).resolve(),h.displayProgress(4),h.countAuthorAreas(),k.yield(h.loadCountryInfo(h.countryInfo,h.countryAbbrv),6);case 6:h.addListeners(),
CSRankings.geoCheck(),h.rank(),k.jumpToEnd()}})})})()};CSRankings.updateMinimum=function(a){return 500>=CSRankings.minToRank?(a=a.scrollTop,CSRankings.minToRank=5E3,CSRankings.getInstance().rank(),a):0};CSRankings.getInstance=function(){return CSRankings.theInstance};CSRankings.promise=function(a){"undefined"!==typeof Promise?Promise.resolve().then(a):setTimeout(a,0)};
...
CSRankings.prototype.buildDropDown=function(a,b,c){var d=this,f={},g={},e;for(e in a){if(a.hasOwnProperty(e)){var h='<div class="table"><table class="table table-sm table-striped"><thead><th></th><td><small><em><abbr title="Click on an author\'s name to go to their DBLP entry.">Faculty</abbr></em></small></td><td align="right"><small><em>&nbsp;&nbsp;<abbr title="Total number of publications (click for DBLP entry).">#&nbsp;Pubs</abbr> </em></small></td><td align="right"><small><em><abbr title="Count divided by number of co-authors">Adj.&nbsp;#</abbr></em></small></td></thead><tbody>';g.$jscomp$loop$prop$fc$22=
...
'"></span>&nbsp;');this.scholarInfo.hasOwnProperty(l);h+='<td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+m+'" onclick="trackOutboundLink(\''+m+"', true); return false;\">"+g.$jscomp$loop$prop$fc$22[l]+'</a></small></td><td align="right"><small>'+(Math.round(10*c[l])/10).toFixed(1)+"</small></td></tr>"}h+="</tbody></table></div>";f[e]=h}g={$jscomp$loop$prop$fc$22:g.$jscomp$loop$prop$fc$22}}return f};
CSRankings.prototype.buildOutputString=function(a,b,c,d,f){var g=this.makePrologue();g=g+'<thead><tr><th align="left"><font color="#777">#</font></th><th align="left"><font color="#777">Institution</font>'+"&nbsp;".repeat(20)+'</th><th align="right"><abbr title="Geometric mean count of papers published across all areas."><font color="#777">Count</font></abbr></th><th align="right">&nbsp;<abbr title="Number of faculty who have published in these areas."><font color="#777">Faculty</font></abbr></th></tr></thead>';
...
m in b&&(p=b[m]);g+="&nbsp;"+m+('&nbsp;<img src="/flags/'+p+'.png">&nbsp;</td>');g+='<td align="right">'+(Math.round(10*n)/10).toFixed(1)+"</td>";g+='<td align="right">'+c[m];g+="</td>";g+="</tr>\n";g+='<tr><td colspan="4"><div style="display:none;" id="'+h+'-faculty">'+d[m]+"</div></td></tr>";a++;h=n}g+="</tbody></table><br /></div></div>\n<br></body></html>"}else g="<h3>Please select at least one area by clicking one or more checkboxes.</h3>";return g};
